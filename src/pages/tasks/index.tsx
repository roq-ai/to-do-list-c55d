            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  <Th>status</Th>
                  {hasAccess('to_do_list', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>to_do_list</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('to_do_list', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/to-do-lists/view/${record.to_do_list?.id}`}>
                          {record.to_do_list?.name}
                        </Link>
                      </Td>
                    )}
